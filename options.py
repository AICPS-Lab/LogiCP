...
def args_parser():
    ...
    parser.add_argument('--epoch', type=int, default=1, help="# of training epoch")
    ...
    # fine-tune args
    parser.add_argument('--fine_tune_iter', type=int, default=1)
    parser.add_argument('--cluster_fine_tune_iter', type=int, default=1)
    parser.add_argument('--local_updates', type=int, default=1, help="maximum number of local updates")
    ...
    parser.add_argument('--cp_epoch', type=int, default=1)
    ...
    parser.add_argument('--pretrain_iter', type=int, default=1, help="number of training epoch in pretrain")
