...
import numpy as np
import torch
from utils.update import LocalUpdate, compute_cluster_id, dic_loader_without_specm
...
def main():
    ...
    for c in range(args.client):
        client_dataset[c] = {}
        train_loader_private, trainset_shared, calib_loader_private, pre_loader_private, nor_loader_private, val_loader, test_loader, dataset_len = get_shared_dataset_2(c + 30, args.dataset)
   ...
   ############################
    ...
    if args.mode == "pretrain_calib":
        ...
        model_path = f"hdd_{args.method}/saved_pretrain_models_cp_only/"
        print(model_path)
